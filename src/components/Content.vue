		...
		<div id="CT">
          ...
          ">
					<div class="demo-image__preview1">
								...
								<div slot="error">
									<div slot="placeholder" class="error">
										<el-button v-show="showbutton" type="primary" icon="el-icon-upload"
											class="download_bt" v-on:click="true_upload"  style="background-color: #00d9a5; border-color: #00d9a5;">
											上传图像
						...
						<div class="img_info_1" style="border-radius: 0 0 5px 5px; background-color: #00d9a5;">
							<span style="color: white; background-color: #00d9a5; letter-spacing: 6px" >原始图像</span>
						</div>
					</div>
					<div class="demo-image__preview2">
						...
						<div class="img_info_1" style="border-radius: 0 0 5px 5px; background-color: #00d9a5;">
							<span style="color: white; letter-spacing: 4px; background-color: #00d9a5;">检测结果</span>
						</div>
					</div>
				</el-card>
			</div>
			<div id="info_patient">
				...
				<el-card style="border-radius: 8px">
					<div slot="header" class="clearfix">
						<span>检测结果</span>
						<el-button style="margin-left: 35px; background-color: #00d9a5; border-color: #00d9a5;" v-show="!showbutton" type="primary" icon="el-icon-upload"
							class="download_bt" v-on:click="true_upload2">
							重新选择图像
							<input ref="upload2" style="display: none" name="file" type="file" @change="update" />
						</el-button>
					</div>
					<el-tabs v-model="activeName" style="color: #00d9a5;">
							...
							<el-table :data="feature_list" height="390" border style="width: 750px; text-align: center"
								...
								<el-table-column label="类别" width="375px">
